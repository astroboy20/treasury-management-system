...
import type { AllowedMimeType, DocumentType } from '@/lib/constants/document.constants'

// Re-export types for consumers that only import from this module
export type { DocumentType, AllowedMimeType } from '@/lib/constants/document.constants'
