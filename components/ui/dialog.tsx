  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        className={cn(
          // zoom-in/zoom-out (scale transforms) are suppressed by the global
          // prefers-reduced-motion rule in globals.css; fade-in/fade-out (opacity)
          // are intentionally retained so state changes remain perceivable (Req 32.9).
